...
export const academicService = {
  ...
  subjectRank: async (
    ...
    const response = await axios.put(`${API_BASE}/ranks/subject`, {
      classId,
      year,
      termId,
      sequenceId,
  ...
  sequenceRank: async (
    ...
    const response = await axios.put(`${API_BASE}/ranks/sequence`, {
      classId,
      year,
      termId,
      sequenceId,
  ...
  termRank: async (
    ...
    const response = await axios.put(`${API_BASE}/ranks/term`, {
      classId,
      year,
      termId,
    });
  ...
  academicRank: async (
    ...
    const response = await axios.put(`${API_BASE}/ranks/academic`, {
      classId,
      year
    });
    return response.data;
