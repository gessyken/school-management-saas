...
export const anglophonieSubjects: SubjectData[] = [
  ...
  },
  {
    ...
    levels: ['Form 3', 'Form 4', 'Form 5', 'Lower Sixth', 'Upper Sixth'],
    coefficient: 3
  },
  {
    subjectCode: 'PHYS',
  ...
  },
  {
    ...
    levels: ['Form 4', 'Form 5', 'Lower Sixth', 'Upper Sixth'],
    coefficient: 3
  },
  {
    subjectCode: 'ACC',
  ...
  },
  {
    ...
    levels: ['Lower Sixth', 'Upper Sixth'],
    coefficient: 4
  },
  {
    subjectCode: 'COMP',
...
// Fonction pour obtenir tous les niveaux disponibles
export const getAllLevels = (): string[] => {
  return [
    // Francophone - Collège
    '6ème', '5ème', '4ème', '3ème',
    // Francophone - Lycée avec séries
    '2nde', '1ère A', '1ère C', '1ère D', '1ère TI',
    'Terminale A', 'Terminale C', 'Terminale D', 'Terminale TI',
    // Anglophone - Secondary
    'Form 1', 'Form 2', 'Form 3', 'Form 4', 'Form 5',
    // Anglophone - Advanced Level avec séries
    'Lower Sixth A', 'Lower Sixth C', 'Lower Sixth D', 'Lower Sixth TI',
    'Upper Sixth A', 'Upper Sixth C', 'Upper Sixth D', 'Upper Sixth TI'
  ];
};

// Fonction pour obtenir les niveaux par cycle
export const getLevelsByCycle = () => {
  return {
    college: {
      francophone: ['6e', '5e', '4e', '3e'],
      anglophone: ['Form 1', 'Form 2', 'Form 3', 'Form 4', 'Form 5']
    },
    lycee: {
      francophone: ['2nde', '1ère A', '1ère C', '1ère D', '1ère TI', 'Terminale A', 'Terminale C', 'Terminale D', 'Terminale TI'],
...
export const getLevelsWithSeries = (system: 'francophone' | 'anglophone') => {
  ...
  if (system === 'francophone') {
    return {
      premiere: series.map(s => `1ère ${s}`),
      terminale: series.map(s => `Terminale ${s}`)
    };
  } else {
    return {
      lowerSixth: series.map(s => `Lower Sixth ${s}`),
      upperSixth: series.map(s => `Upper Sixth ${s}`)
    };
  }
};